...
@section('title', isset($user) ? 'Update ' . $user->name : 'Creare user')
...
@section('content')
    ...
    <form method="POST"
        ...
        <div class="row">
            <div class="col">
                <input name="name" value="{{ old('name', isset($user) ? $user->name : null) }}"
        ...
        <div class="row mt-3">
            <div class="col">
                <input name="email" value="{{ old('email', isset($user) ? $user->email : null)}}"
